...
(function ($) {
    ...
    function selectAll(target) {
        ...
        $("tr", tBody).addClass("hiMallDatagrid-row-selected");
        $("div.hiMallDatagrid-cell-check input[type=checkbox]", tBody)
            .not("div.hiMallDatagrid-cell-check input[disabled]")
            .prop("checked", true);
    ...
    function bindCellsEvents(target) {
        ...
        $("div.hiMallDatagrid-cell-check input[type=checkbox]").unbind("click").bind("click", function (e) {
