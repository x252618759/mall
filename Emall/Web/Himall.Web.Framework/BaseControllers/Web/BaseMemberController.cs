...
namespace Himall.Web.Framework
{
    ...
    public abstract class BaseMemberController : BaseWebController
    {
        ...
        protected override void OnAuthorization(AuthorizationContext filterContext)
        {
            ...
            //var IsOpenMemberInvite = ConfigurationManager.AppSettings["IsOpenMemberInvite"];
            //ViewBag.IsOpenMemberInvite = IsOpenMemberInvite == null ? true : bool.Parse(IsOpenMemberInvite);
            //var IsOpenLimitTime = ConfigurationManager.AppSettings["IsOpenLimitTime"];
            //ViewBag.IsOpenLimitTime = IsOpenLimitTime == null ? true : bool.Parse(IsOpenLimitTime);
            ////不能应用在子方法上
            ...
            //        if (CurrentSellerManager != null && !IsMobileTerminal)
